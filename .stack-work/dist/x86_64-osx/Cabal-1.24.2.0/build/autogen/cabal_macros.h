...
/* package manifest-generator-0.1.0.0 */
#define VERSION_manifest_generator "0.1.0.0"
#define MIN_VERSION_manifest_generator(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "manifest-generator-0.1.0.0"

#define CURRENT_PACKAGE_KEY "manifest-generator-0.1.0.0"
